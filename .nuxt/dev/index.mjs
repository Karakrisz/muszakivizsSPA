import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getRequestHost, getRequestProtocol, setHeader, getHeader, getQuery as getQuery$1, readBody, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getResponseStatusText } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/devalue/index.js';
import destr from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withoutTrailingSlash, withBase } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/errx/dist/index.js';
import { isVNode, toValue, version, unref } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/vue/index.mjs';
import devalue from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/@nuxt/devalue/dist/devalue.mjs';
import nodemailer from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/nodemailer/lib/nodemailer.js';
import options from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/.nuxt/nuxt-mail/options.mjs';
import send$1 from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/.nuxt/nuxt-mail/send.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/pathe/dist/index.mjs';
import { hash } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/ohash/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/node_modules/@unhead/shared/dist/index.mjs';
...
const _joaPCVjW5Q = (function(nitro) {
...
const _inlineRuntimeConfig = {
    ...
    "routeRules": {
      ...
      "/sitemap.xml": {
        "headers": {
          ...
          "X-Sitemap-Prerendered": "2025-05-22T18:51:24.514Z"
        }
      },
      "/_nuxt/builds/meta/**": {
        "headers": {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/public"
      ]
    },
    "http": {
      "domains": []
...
const serverAssets = [{"baseName":"server","dir":"/Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _JdK5rTQenh = defineNitroPlugin(async (nitroApp) => {
...
const _Q5sEfn = defineEventHandler(async (e) => {
...
const _LQMJqT = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _anOrZ7 = defineEventHandler(async (e) => {
...
const _yYFXyo = defineEventHandler(async (e) => {
...
const _22ztHd = defineEventHandler(async (e) => {
...
const _pmjbG4 = defineEventHandler(async event => {
  try {
...
const _L4nrZU = lazyEventHandler(() => {
...
const handlers = [
  ...
  { route: '/__sitemap__/debug.json', handler: _anOrZ7, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _yYFXyo, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _22ztHd, lazy: false, middleware: false, method: undefined },
  { route: '/mail/send', handler: _pmjbG4, lazy: false, middleware: false, method: "post" },
  { route: '/_ipx/**', handler: _L4nrZU, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_2d6rxn, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/muszakivizsSPA/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
